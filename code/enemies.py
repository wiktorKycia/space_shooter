...
class BaseEnemy(object):
    def __init__(self, game, imagepath, x, y, slip, mov_force, mass, shot_force, barrel_lenght, health):
        ...
        self.hp = DeluxeHP(self.game, health, self.pos.x - self.width/2, self.pos.y-50, 50, 10)
...
class Enemy1(BaseEnemy):
    def __init__(self, game, x, y):
        ...
        super().__init__(self.game, self.image, x, y , 0.99, 100, 50, 800, 5, 100000)
...
class Enemy2(BaseEnemy):
    def __init__(self, game, x, y):
        ...
        super().__init__(self.game, self.image, x, y , 0.99, 150, 100, 1200, 5, 250000)
...
class Enemy3(BaseEnemy):
    def __init__(self, game, x, y):
        ...
        super().__init__(self.game, self.image, x, y , 0.98, 540, 350, 2500, 6, 450000)
